...
<div class="prose">
	<p class="mt-5">
		<strong>Achtung bei Jobwechsel / AMS-Bezug o.ä.: </strong><em
			...
			>
			zu haben, muss mindestens einer 6 Monate (182 Kalendertage) durchgehend gearbeitet haben – der
			Vater vor Geburt 6 Monate (182 Kalendertage) oder die Mutter vor dem Mutterschutz 6 Monate (182
			Kalendertage). Arbeitslosengeld, Notstandshilfe, Weiterbildungsgeld darf nicht bezogen worden sein
			(Quelle:
			<a href="https://www.gesundheitskasse.at/cdscontent/?contentid=10007.880037">ÖGK</a>). Hat nur
			einer von euch Anspruch, kann der andere
			<a
			...
			> beziehen, siehe Beispiel unten. Wenn beide keinen Anspruch haben, ist nur Pauschales Kinderbetreuungsgeld
			möglich.</em
		>
	</p>
</div>
...
{#if toolAvailable}
	<div
		class="mt-6 grid gap-3 rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 md:grid-cols-[220px_1fr] md:items-center"
	>
...
{:else}
	<p class="mx-auto mt-5 font-semibold">🚧 Tool ist noch in Entwicklung 🚧</p>
{/if}
